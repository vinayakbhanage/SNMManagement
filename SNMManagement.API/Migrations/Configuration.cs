namespace SNMManagement.API.Migrations
{
    ...
    internal sealed class Configuration : DbMigrationsConfiguration<SNMManagementContext>
    {
        ...
        protected override void Seed(SNMManagementContext context)
        {
            ...
            //context.Database.ExecuteSqlCommand("TRUNCATE TABLE Attendances");
            //context.Database.ExecuteSqlCommand("TRUNCATE TABLE Satsangs");
            //context.Database.ExecuteSqlCommand("TRUNCATE TABLE Sewadars");
            //context.Database.ExecuteSqlCommand("TRUNCATE TABLE Mahatmas");
            //context.Database.ExecuteSqlCommand("TRUNCATE TABLE DutyCharts");
            //context.Database.ExecuteSqlCommand("TRUNCATE TABLE SewadarDesignations");
            //context.Database.ExecuteSqlCommand("TRUNCATE TABLE SatsangTypes");
            //context.Database.ExecuteSqlCommand("TRUNCATE TABLE Areas");
            //context.Database.ExecuteSqlCommand("TRUNCATE TABLE Units");
            //context.Database.ExecuteSqlCommand("TRUNCATE TABLE Khetras");
